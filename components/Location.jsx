...
const locationLandmarks = [
  { name: 'IFFCO Chowk', dist: '30 Mins' },
  { name: 'Rajiv Chowk', dist: '22 Mins' },
  { name: 'Yashobhoomi Convention Centre', dist: '20 Mins' },
  { name: 'IGI Airport', dist: '30 Mins' },
  { name: 'Dwarka Expressway', dist: 'Close by' },
  { name: 'Pataudi Road', dist: 'Well connected' },
  { name: 'Schools, Hospitals & Malls', dist: 'Within easy reach' },
]
        ...
        <div className="flex flex-col lg:flex-row gap-8 items-stretch">
          ...
          <div className="w-full lg:flex-1 lg:order-1 flex flex-col justify-center" data-aos="fade-right" data-aos-duration="1000">
            <div style={{
              ...
              <iframe 
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d7017.04156458499!2d76.954937!3d28.4337135!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x390d1637123bd8f3%3A0x2afbdf9b1898adf6!2sSector%2088A%2C%20Gurugram%2C%20Haryana%20122505!5e0!3m2!1sen!2sin!4v1789382457912!5m2!1sen!2sin" 
              ...
              <div style={{
                ...
                <span style={{
                  ...
                  Sector 88A, Dwarka Expressway, Gurgaon
                </span>
              </div>
            </div>
          </div>
